...
print('gs4 to_embed:', cur.fetchone()[0])
cur.execute("SELECT COUNT(*) FROM upsc_chunks WHERE gs_paper='gs4' AND embedding IS NOT NULL")
print('gs4 embedded:', cur.fetchone()[0])
c.close()
